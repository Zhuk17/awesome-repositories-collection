...
<p align="center">
<a href="README.md"> distrito financiero inglés</a> •
<a href="README.ru.md"> Desnudar Русский</a> •
<a href="README.zh-CN.md">简
</p>

<p align="center">
<img src="XG0370H alt="Awesome">
<img src="XG0369H alt="License">
<img src="XG0368H alt="Stars">
</p>
...
- **301+** herramientas y recursos curados
...
- **[httpie](https://github.com/httpie/cli)** — Cliente HTTP amigable con el usuario para probar APIs. Sintaxis expresiva con resaltado de sintaxis y soporte JSON fuera de la caja.
...
- **[share](https://github.com/schollz/share)** — Transferencia de archivos cifrados a extremo a extremo a través de la web o CLI. Garantizar el intercambio de archivos entre pares sin servidores intermediarios.
...
**[Mirotalk](https://github.com/mirotalk/mirotalk)** — videoconferencia P2P a través de WebRTC. Una alternativa sencilla y rápida a Zoom y Google Meet con conexiones entre pares.
...
- **[Wild Linker](https://github.com/wild-linker/wild)** - Enlace rápido de código abierto escrito en Rust. Linker de alto rendimiento para optimizar los tiempos de construcción y reducir tamaños binarios.
...
**[Parm](https://github.com/parm-pm/parm)** — Gestor de paquetes multiplataforma tirando las liberaciones directamente de GitHub. Gestión sencilla de dependencia para proyectos de código abierto.
...
**[DBeaver](https://github.com/dbeaver/dbeaver)** — Herramienta de base de datos universal que soporta los tipos de base de datos 100+. Editor SQL, diagramas ER, visualización de datos y ejecución de consultas para MySQL, PostgreSQL, MongoDB y más.
...
- **[Taskfile](https://github.com/go-task/task)** — Herramienta de construcción y corredor de tareas. Una alternativa más simple para hacer con soporte multiplataforma y configuración YAML.
...
- **[Omnivore](https://github.com/omnivore-app/omnivore)** — Servicio de lectura-más tarde con sincronización. Guardar artículos, boletines y documentos para la lectura posterior en todos los dispositivos.
...
**[osTicket](https://github.com/osTicket/osTicket)** — Sistema popular de gestión de tickets para el soporte al cliente. Solución de ayuda basada en PHP confiada por miles de organizaciones.
...
**[TastyIgniter](https://github.com/tastyigniter/TastyIgniter)** — Plataforma de restaurantes y sistema de pedidos en línea. Solución basada en Laravel para gestionar restaurantes y entrega de alimentos.
...
**[Pars Local Player (PLP)](https://github.com/pars-local-player/pars-local-player)** — Reproductor de vídeo ligero sin telemetría o seguimiento. Reproductor multimedia centrado en la privacidad con interfaz limpia.
...
**[gitleaks](https://github.com/gitleaks/gitleaks)** — Herramienta SAST para detectar secretos codificados duros en repositorios de git. Scan commits, ramas e historias enteras.
**[sherlock](https://github.com/sherlock-project/sherlock)** — Cuentas de redes sociales de caza por nombre de usuario en más de 300 sitios web. Herramienta OSINT basada en Python.
...
**[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line)** — Domine la línea de comandos en una página. Ejemplos prácticos para el uso diario.
...
- **[build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)** — Aprende construyendo tu propia versión de tecnologías. Tutoriales para bases de datos, servidores web, Git, Docker y más.
...
<p align="center">
<sub>Curated with μ for the developer community</sub>
</p>
