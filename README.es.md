...
<p align="center">
<img src="XG0482H alt="Awesome">
<img src="XG0481H alt="License">
<img src="XG0480H alt="Stars">
</p>
...
- **[exa](https://github.com/ogham/exa)** — Reemplazo moderno para `ls` con integración git, vista a los árboles y tipos de archivos codificados por colores para una mayor legibilidad.
...
- **[qView](https://github.com/jurplel/qView)** — Minimalista y visor de imagen rápida para escritorio. Ligero con navegación por teclado, soporta todos los formatos de imagen principales.
**[cloudcmd](https://github.com/coderaiser/cloudcmd)** — Administrador de archivos basado en la web con consola integrada y editor. Acceso y administración de archivos remotamente a través de una interfaz del navegador.
...
**[CopyQ](https://github.com/hluk/CopyQ)** — Advanced clipboard manager with searchable history. Almacene y organice entradas de portapapeles con etiquetas, notas y soporte de scripting.
...
**[Netdata](https://github.com/netdata/netdata)** — Monitoreo del desempeño en tiempo real para sistemas y aplicaciones. Distribuido, en tiempo real, monitoreo de salud y solución de problemas de rendimiento.
...
- **[starship](https://github.com/starship/starship)** - Previsión de minimalista. Inauguración rápida y personalizable para cualquier shell con estado de git, trabajos y información de directorio.
...
**XC04D** — Plataforma de automatización de hogares de código abierto. Centro hogar inteligente con control de dispositivos, automatización y amplio ecosistema de integración.
...
**[NixOS](https://github.com/NixOS/nixpkgs)** — Distribución declarativa de Linux con construcciones reproducibles. Gestor de paquetes puramente funcional con actualizaciones atómicas y retrocesos.
...
**[Postman](https://freecodecamp.org/news/master-api-testing-with-postman)** — Versión gratuita de código abierto de Postman para las pruebas de API. Ambiente completo de desarrollo de API con capacidades de prueba automatizadas.
...
Las utilidades de control de versiones que mejoran su flujo de trabajo Git.
...
**[tig](https://github.com/jonas/tig)** — Interfaz de movimiento de texto para Git. Examine la historia del repositorio, la vista de la culpa y la navegación del árbol en el terminal.
...
- **[delta](https://github.com/dandavison/delta)** — Pager de sintaxis para la salida de git, diff y grep. Hace que la revisión de código sea más agradable con los diffs lado a lado.
- **[Wild Linker](https://github.com/wild-linker/wild)** - Enlace rápido de código abierto escrito en Rust. Linker de alto rendimiento para optimizar los tiempos de construcción y reducir los tamaños binarios.

### Code Editors

Modernos editores de texto optimizados para productividad y extensibilidad.

**[Neovim](https://github.com/neovim/neovim)** — editor de texto basado en Vim Hyperextensible. Soporte LSP incorporado, configuración Lua y ecosistema de plugin moderno.
...
**[micro](https://github.com/zyedidia/micro)** — Moderno e intuitivo editor de texto terminal. Admite la entrada del ratón y la unión de teclas comunes (Ctrl+C, Ctrl+V).
...
- **[Notepad++](https://notepad-plus-plus.org/)** — Editor de códigos y texto ricos en función de las características para Windows. Soporta todos los idiomas de programación con resaltado de sintaxis y plugins.
...
- **[delve](https://github.com/go-delve/delve)** — Debugger for the Go programming language. Soporta goroutines, canales y funciones de depuración Go-specific.
**[pdb++](https://github.com/pdbpp/pdbpp)** — Depurador mejorado de Python con resaltado de sintaxis, finalización de pestañas y mejor introspección.
...
**[Cronboard](https://github.com/cronboard-io/cronboard)** — Panel de gestión de empleo basado en texto. Monitorear y gestionar tareas programadas desde una interfaz simple.
...
**[hyperfine](https://github.com/sharkdp/hyperfine)** — Herramienta de referencia de línea de comandos con análisis estadístico. Carreras de calentamiento, parámetros de referencia y exportación a diversos formatos.
- **[flamegraph](https://github.com/brendangregg/FlameGraph)** - Visualizador de traza de traza para el perfil de rendimiento. Identificar hotspots en aplicaciones intensivos en CPU.
...
- **[lazydocker](https://github.com/jesseduffield/lazydocker)** - Terminal UI para Docker y Docker Compose. Administrar contenedores, ver registros, inspeccionar imágenes y reiniciar servicios con atajos de teclado.
...
**[MinIO](https://github.com/minio/minio)** — Almacenamiento de objetos compatible con S3 de alto rendimiento. Una alternativa auto hospeda a AWS S3 con características empresariales.
...
**[ArchiveBox](https://github.com/ArchiveBox/ArchiveBox)** — Archivo web auto hospedado. Descargar y guardar sitios web para ver fuera de línea con búsqueda de texto completo.
...
**[Appwrite](https://github.com/appwrite/appwrite)** — Backend-as-a-service platform. Solución autoanfitriona para construir aplicaciones web y móviles con autenticación, bases de datos y almacenamiento.
...
**[Bun](https://github.com/oven-sh/bun)** — Fast all-in-one JavaScript runtime, packager, and package manager. Reemplazo de salida para Node.js con soporte de TipoScript nativo y velocidad de apalancamiento.
...
**[pnpm](https://github.com/pnpm/pnpm)** — Fast, disquete eficiente gestor de paquetes. Utiliza enlaces duros y enlaces para guardar espacio de disco manteniendo la compatibilidad con npm.
**[Flutter](https://flutter.dev)** — Marco UI multiplataforma para la construcción de hermosas aplicaciones nativas. SDK de código abierto de Google para construir aplicaciones móviles, web y de escritorio desde una sola base de código.
...
**[Moleculer](https://github.com/moleculerjs/moleculer)** — Marco rápido, moderno y potente de microservicios para Node.js. Marco de microservicios progresivos con descubrimiento de servicio incorporado y equilibrio de carga.
...
**[DevPod](https://github.com/loft-sh/devpod)** — Herramienta única para crear ambientes dev reproducibles. Funciona con Docker, Kubernetes y proveedores de nube.
**[Taskfile](https://github.com/go-task/task)** — Herramienta de ejecución y construcción de tareas. Una alternativa más simple para hacer con soporte multiplataforma y configuración YAML.
...
- **[act](https://github.com/nektos/act)** - Run GitHub Actions localmente. Prueba los flujos de trabajo antes de empujar para evitar el ensayo y el terror en el CI.
...
- **[Documize community](https://github.com/documize/community)** — Base de conocimiento auto-anfitriona con funcionalidad wiki. Organizar documentación, runbooks y conocimientos de equipo en un solo lugar.
...
**[ETL Pipeline Builder](https://github.com/ETL-Pipeline-Builder/etl-pipeline-builder)** — constructor de tuberías ETL visual de código bajo. Construir flujos de trabajo de transformación de datos con interfaz de arrastrar y soltar.
...
- **[Omnivore](https://github.com/omnivore-app/omnivore)** — Servicio de lectura-establecido con sincronización. Guardar artículos, boletines y documentos para la lectura posterior en todos los dispositivos.
...
**[super-productivity](https://github.com/johannesjo/super-productivity)** — Administrador de tareas y rastreador de proyectos. Seguimiento del tiempo, integración Jira y temporizador Pomodoro para la máxima productividad.
...
- **[Hoppscotch](https://github.com/hoppscotch/hoppscotch)** — Moderno, hermoso cliente de pruebas de API. alternativa auto hospeda al Postman con interfaz intuitiva y características poderosas.
...
**[Leantime](https://github.com/Leantime/leantime)** — Sistema de gestión de proyectos sencillo y poderoso y de planificación estratégica. Apoyo a la metodología ágil con juntas kanban y seguimiento del tiempo.
**[Memos](https://github.com/usememos/memos)** — Servicio ligero de toma de notas con soporte Markdown. Una alternativa a Twitter/X para notas y pensamientos rápidos.
...
**[TastyIgniter](https://github.com/tastyigniter/TastyIgniter)** — Plataforma de restaurantes y sistema de pedidos en línea. Solución basada en Laravel para gestionar restaurantes y suministro de alimentos.
...
**[Logseq](https://github.com/logseq/logseq)** — Gestión de conocimientos y plataforma de toma de notas, primera y de código abierto. Herramienta local-primera con conexión bidireccional y vista gráfica.
...
**[Notabase](https://github.com/chadly/notabase)** — Aplicación potente de toma de notas diseñada para el pensamiento en red. Crear notas conectadas con enlaces bidireccionales y visualización de gráficos.
...
**[Vikunja](https://github.com/go-vikunja/vikunja)** — Aplicación para hacer con muchas características. Gestión de tareas de código abierto con listas, tableros de kanban y gráficos Gantt.
...
**[Mattermost](https://github.com/mattermost/mattermost)** — Open-source, self-hosted Slack alternative. Plataforma de comunicación de equipo segura con intercambio de archivos e integraciones.
...
**[Signal](https://github.com/signalapp/Signal-Desktop)** — Mensajero privado con cifrado de extremo a extremo. Plataforma de mensajería de código abierto enfocada en privacidad y seguridad.
...
- **[LocalAI](https://github.com/mudler/LocalAI)** — Reemplazo de inserción para OpenAI API funcionando localmente. Utilice hardware de grado de consumo para ejecutar LLMs, generar imágenes y sintetizar el audio.
...
- **[open-codex](https://github.com/ymichael/open-codex)** - Agente terminal impulsado por AI. Funciona con varios backends de LLM para ayudar con tareas de codificación directamente en el terminal.
...
**[VoltAgent](https://github.com/VoltAgent/volt)** — Marco y constructor de cadenas de agentes AI. Kit de herramientas de código abierto para la construcción de sistemas complejos de múltiples agentes.
...
Plataformas y herramientas continuas de integración y despliegue continuo.

**[GitHub Actions](https://github.com/features/actions)** — Automatización del flujo de trabajo para construir, probar y implementar código. Integración nativa con repositorios GitHub.
**[GitLab](https://gitlab.com/gitlab-org/gitlab)** — Plataforma completa de DevOps con repositorio Git, tuberías CI/CD, seguimiento de emisiones y registro de contenedores.
**[GoCD](https://github.com/gocd/gocd)** — Servidor de entrega continuo de código abierto. Modelo de tubería complejo con visualización de flujo de valor.
...
- **[Apache JMeter](https://freecodecamp.org/news/jmeter-performance-testing)** — Herramienta de prueba de carga gratuita para analizar y medir el rendimiento. Solución de código abierto para pruebas de rendimiento de aplicaciones.
**[k6](https://github.com/grafana/k6)** — Herramienta moderna de pruebas de carga para pruebas de rendimiento. Base de JavaScript con potentes capacidades de scripting para pruebas de carga, estrés y pico.
...
**[Sora Extend](https://github.com/mshumer/sora-extend)** — Herramienta para encadenar y extender OpenAI Sora 2 generaciones de vídeo más allá de 12 segundos límite. Automatizado deconstrucción rápida y concatenación de segmentos.
...
- **[Kdenlive](https://github.com/KDE/kdenlive)** - Editor de vídeo libre y de código abierto. Software profesional de edición de vídeo no lineal con edición y efectos multi-track.
...
**[OBS Studio](https://obsproject.com/)** — Software de transmisión y grabación de código abierto. Grabar escritorio, transmitir a Twitch/YouTube y capturar llamadas para archivos.
...
**[Vexa](https://github.com/Vexa-ai/vexa)** — API de autoorganización para la automatización de las transcripciones de reuniones. Solución de código abierto para la conversión automatizada de audio a texto y resúmenes de reuniones.
**[Audiobook Generator](https://github.com/BookxDev/bookxAI)** — Creación de audiolibro accionado por IA del texto. Herramienta de código abierto que genera audiolibros de sonido natural utilizando tecnología de texto a voz.
...
- **[Godot Engine](https://github.com/godotengine/godot)** — Motor de juego 2D y 3D de código libre y abierto. Desarrollo de juego multiplataforma con scripting visual y extenso conjunto de funciones.
...
- **[SuperTuxKart](https://github.com/supertuxkart/stk-code)** — Juego de carreras 3D kart. Juego divertido de carreras con Tux y amigos con varias pistas y modos.
...
- **[GIMP](https://www.gimp.org/)** — Editor de imagen libre y de código abierto. alternativa profesional a Photoshop para edición de fotos, creación de logotipos y diseño gráfico.
...
Herramientas de código abierto y bibliotecas para la visión computarizada 3D, escaneado, reconstrucción y procesamiento de nubes de puntos.
...
**[CloudCompare](https://github.com/CloudCompare/CloudCompare)** — Herramienta de análisis y procesamiento de nubes de puntos de código abierto. Importar/exportar formatos estándar, generación de malla, filtrado y scripting. Esencial para comparar, fusionar y analizar las nubes de puntos.
...
- **[OpenCV](https://github.com/opencv/opencv)** — Biblioteca fundamental de visión informática. Incluye algoritmos para visión estéreo, procesamiento de profundidad, generación de nube de puntos, cámaras estéreo y procesamiento posterior.
**[Salingo Virtual 3D Scanner](https://github.com/Salingo/virtual-3d-scanner)** — Generador de imagen y nube de puntos RGB-D sintético. Analiza modelos virtuales 3D para generar conjuntos de datos para la formación y desarrollo de la visión informática.
...
**[Potree](https://github.com/potree/potree)** — renderizador de nube de punto basado en WebGL para conjuntos de datos grandes. Visor interactivo basado en navegadores que soporta millones de puntos con herramientas de renderización y medición de nivel de detalle.
- **[PointLLM](https://github.com/OpenRobotLab/PointLLM)** — Extende los modelos de lenguaje grande para entender las nubes de puntos. Permite el razonamiento 3D de cero instantánea, la respuesta de preguntas y la comprensión de escena de los datos de nube de puntos. [ECCV 2024 Best Paper Candidate]
...
**[OpenSCADA / Eclipse SCADA](https://openscada.org)** Silencio [Eclipse SCADA](https://eclipse.org/scada) — Plataforma potente para la adquisición, visualización, gestión y automatización de datos (HMI, Modbus, OPC, SNMP, protocolos IEC, archivo, scripting). Adecuado para fabricación, energía, transporte, integración de PLC y soluciones personalizadas.
...
**[TensorFlow Smart Buildings Simulator](https://goo.gle/oTOwjRBPmo)** — Simulador abierto para la gestión de la energía. Plataforma de código abierto de Google para desarrollar y probar algoritmos inteligentes de control de edificios.
...
**[BlenderBIM](https://blenderbim.org)** — Extende Blender para proyectos BIM. Soporte de IFC, detección de choques, generación de documentación.
...
**[IfcOpenShell](https://github.com/IfcOpenShell/IfcOpenShell)** — Biblioteca para trabajar con formatos IFC/BIM. Generación, perfeccionamiento e integración en proyectos de automatización y construcción.
...
**[awesome-security](https://github.com/sbilly/awesome-security)** — Lista curada de recursos de seguridad que incluyen herramientas, marcos y materiales de aprendizaje.
...
**[gitleaks](https://github.com/gitleaks/gitleaks)** — Herramienta SAST para detectar secretos codificados duros en repositorios de git. Scan commits, ramas y historias enteras.
**[sherlock](https://github.com/sherlock-project/sherlock)** — Caza cuentas de redes sociales por nombre de usuario en más de 300 sitios web. Herramienta OSINT basada en Python.
...
**[OWASP Amass](https://github.com/owasp-amass/amass)** — Cartografía de superficie de ataque profundo y descubrimiento de activos. Cartografía de redes de organizaciones a través de chatarra y APIs.
- **[SpiderFoot](https://github.com/smicallef/spiderfoot)** — Herramienta de recogida automática OSINT con interfaz web. Reunir información sobre objetivos de 100+ fuentes.
**[OWASP Juice Shop](https://github.com/juice-shop/juice-shop)** — Aplicación web insegura para capacitación en seguridad. Práctica encontrando y explotando vulnerabilidades.
...
**[Vaultwarden](https://github.com/dani-garcia/vaultwarden)** — Gestor de contraseñas compatible con Bitwarden. Implementación del servidor ligero con todas las funciones del cliente Bitwarden.
...
**[trufflehog](https://github.com/trufflesecurity/trufflehog)** — Detectar secretos filtrados en repositorios de git. Scans compromete, sucursales y PRs para credenciales expuestas y claves API.
...
**[GrapheneOS](https://grapheneos.org/)** — Distribución de Android centrada en la privacidad y la seguridad. Mejora de las funciones de seguridad y sistema endurecido para la máxima privacidad.
...
**[Keycloak](https://github.com/keycloak/keycloak)** — Solución de gestión de la identidad y el acceso de código abierto. Añadir autenticación a aplicaciones con cambios mínimos de código.
...
**[KeeWeb](https://github.com/keeweb/keeweb)** — Administrador de contraseñas multiplataforma compatible con KeePass. Interfaz web para gestionar bases de datos de contraseñas cifradas.
...
- **[OSSU Computer Science](https://github.com/ossu/computer-science)** - Camino a la educación gratuita en ciencias informáticas. Programa de grado completo usando cursos en línea.
...
- **[The Missing Semester](https://github.com/missing-semester/missing-semester)** — Curso MIT sobre herramientas informáticas que cada desarrollador debe saber. Shell, vim, git, debugging, y más.
**[The Art of Command Line](https://github.com/jlevy/the-art-of-command-line)** — Domine la línea de comandos en una página. Ejemplos prácticos para uso diario.
...
- **[LearnGitBranching](https://github.com/pcottle/learnGitBranching)** — tutorial interactivo de Git visual. Master ramificación, fusión, rebasado y avanzado Git flujos de trabajo a través de ejercicios prácticos.
**[Joplin](https://github.com/laurent22/joplin)** — Aplicación de toma de notas multiplataforma. Editor de marcado con sincronización, cifrado y soporte de plugin.
...
##  tuya Other Awesome Collections

Listas curadas que abarcan temas y herramientas especializados.
...
**[awesome-shell](https://github.com/alebcay/awesome-shell)** — Marcos de línea de comandos, toolkits, guías y gizmos.
...
- **[yolo-training-template](https://github.com/mfranzon/yolo-training-template)** — Plantilla lista para usar para entrenar modelos YOLO en cualquier conjunto de datos de Kaggle en pocas horas. Gasoducto completo con auto-etiquetado utilizando GroundingDINO, scripts de entrenamiento y ejemplos de inferencia.

### Contribuir tesis

Utilice el [template](./theses/thesis_template_en.md) proporcionado para contribuir su propia investigación y análisis.
...
**[build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)** — Programación maestra recreando sus tecnologías favoritas desde cero. Tutoriales para construir bases de datos, servidores web, Git, Docker y más.
- **[awesome-lists](https://github.com/mthcht/awesome-lists)** - Una lista impresionante de listas impresionantes. Directorio completo de listas curadas que abarcan todos los aspectos de la tecnología y el desarrollo.
**[AITreasureBox](https://github.com/superiorlu/AITreasureBox)** — Colección de herramientas, marcos y recursos relacionados con la IA. Curado tesoro de las tecnologías y aplicaciones de inteligencia artificial.
- **[Awesome-Spiking-Neural-Networks](https://github.com/TheBrainLab/Awesome-Spiking-Neural-Networks)** — Lista curada de investigación, herramientas y recursos de red neuronales. Colección completa para la computación neuromorfo y la IA inspirada en el cerebro.
**[awesome-naming](https://github.com/gruhn/awesome-naming)** — Lista curada de herramientas y recursos para nombrar cosas en el desarrollo del software. Guías y herramientas útiles para elegir buenos nombres variables, nombres de proyectos y más.
...
**[fucking-the-book-of-secret-knowledge](https://github.com/Correia-jpv/fucking-the-book-of-secret-knowledge)** — Lista curada de conocimiento secreto y gemas ocultas en tecnología. Alternativa a "El Libro del Conocimiento Secreto" con contribuciones comunitarias.
**[awesome-android-root](https://github.com/awesome-android-root/awesome-android-root)** — Lista curada de herramientas, guías y recursos para Android rooting. Colección completa para Android personalización y desarrollo.
...
**[awesome-docker](https://github.com/veggiemonk/awesome-docker)** — Lista curada de recursos, herramientas y tutoriales de Docker. Guía completa del ecosistema Docker y las mejores prácticas.
...
**[Self-Hosting-Guide](https://github.com/mikeroyal/Self-Hosting-Guide)** — Guía curada para el software y los servicios de auto hospedaje. Tutoriales y recursos completos para aplicaciones auto hospedadas.
...
Gracias especial a @theayushmishr por añadir ytarchive, Goose AI agente framework, y librewolf navegador. ¡Tus contribuciones mejoran enormemente esta colección!

-...

## 📄 License

Este proyecto está bajo la licencia MIT License - ver el archivo [LICENSE.md](LICENSE.md) para obtener más detalles.
