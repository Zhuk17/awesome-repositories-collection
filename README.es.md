...
**[CopyQ](https://github.com/hluk/CopyQ)** Gerente de portapapeles avanzado con historia de búsqueda. Almacene y organice entradas de portapapeles con etiquetas, notas y soporte de scripting.
...
**[share](https://github.com/schollz/share)** — Transferencia de archivos encriptados de extremo a extremo a través de web o CLI. Garantizar el intercambio de archivos entre pares sin servidores intermediarios.
...
**[Postman](https://freecodecamp.org/news/master-api-testing-with-postman)** — Versión gratuita de código abierto de Postman para las pruebas de API. Completo entorno de desarrollo de API con capacidades de prueba automatizadas.
...
**[OpenShift](https://github.com/openshift/origin)** — Plataforma Enterprise Kubernetes de Red Hat. Plataforma de contenedores con herramientas de desarrollo y operaciones automatizadas.
...
**[Vikunja](https://github.com/go-vikunja/vikunja)** — Aplicación para hacer con muchas características. Gestión de tareas de código abierto con listas, tablas de kanban y gráficos Gantt.
...
**[gitleaks](https://github.com/gitleaks/gitleaks)** — Herramienta SAST para detectar secretos codificados en repositorios de git. Scan commits, ramas e historias enteras.
